...
class  FormC{
	...
	function ajouterform($form)
	{
 	...
 	$db = config::getConnexion();
		...
		$sql="SELECT f.id, `titre`, `image`, `contenu`, `likes`, `Date`, `id_User`,lastname as nom,firstname as prenom FROM `form`f INNER JOIN users u where u.id = f.id_User";
		$db = config::getConnexion();
		try{
		$liste=$db->query($sql);
		return $liste;
		...
		$sql="SELECT f.id, `titre`, `image`, `contenu`, `likes`, `Date`, `id_User`,lastname as nom,firstname as prenom FROM `form`f INNER JOIN users u where u.id = :id_User and f.id_User=:id_User
";
		$db = config::getConnexion();
		try{
		$req=$db->prepare($sql);
